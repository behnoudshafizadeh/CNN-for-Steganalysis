...
def load_data(
    ...
    cover_trainset_path=cover_trainset_path.rstrip('\r')
    cover_testset_path=cover_testset_path.rstrip('\r')
    stego_trainset_path=stego_trainset_path.rstrip('\r')
    stego_testset_path=stego_testset_path.rstrip('\r')
